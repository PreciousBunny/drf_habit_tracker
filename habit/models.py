...
class Habit(models.Model):
    ...
    is_pleasurable = models.BooleanField(default=True, verbose_name='Призн. полез. привычки')
    associated_habit = models.ForeignKey('self', **NULLABLE, on_delete=models.SET_NULL,
